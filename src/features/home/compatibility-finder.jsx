  ...
  return (
    <Card className="relative -mt-8 rounded-[2rem] px-5 py-4 sm:px-6 lg:-mt-10">
      <CardHeader className="px-0 pb-4">
        <CardTitle className="text-2xl">Find Compatible Parts</CardTitle>
      </CardHeader>
      <CardContent className="px-0">
        <form className="grid gap-4 xl:grid-cols-[repeat(4,minmax(0,1fr))_auto]" onSubmit={handleSubmit}>
          <div className="space-y-2">
            <label className="text-sm font-medium text-muted-foreground">Select Car Brand</label>
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-muted-foreground">Select Car Model</label>
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-muted-foreground">Select Part Category</label>
