export const dictionaries = {
  en: {
    ...
    googleSignInStartFailed: "Google sign-in could not be started. Please try again.",
    ...
    createYourCustomerAccount: "Create your customer account",
    loginPageDescription:
      "Sign in with your customer account to manage orders, invoices, support activity, and profile details.",
    ...
    wishlistUnavailable: "Wishlist is not available yet.",
    cartUnavailable:
      "Cart is not available. Please use Buy Now for a single item checkout.",
  },
  ar: {
    ...
    googleSignInStartFailed: "تعذر بدء تسجيل الدخول عبر Google. يرجى المحاولة مرة أخرى.",
    ...
    conditionUsedFair: "مستعمل - مقبول",
    conditionReconditioned: "مجدد",
    conditionRefurbished: "معاد تأهيله",
    conditionNew: "جديد",
    conditionUnknown: "غير معروف",
    tested: "مختبر",
    untested: "غير مختبر",
    ...
    createYourCustomerAccount: "أنشئ حساب العميل الخاص بك",
    loginPageDescription:
      "سجل الدخول بحساب العميل لإدارة الطلبات والفواتير ونشاط الدعم وبيانات الملف الشخصي.",
    registerPageDescription:
    ...
    wishlistUnavailable: "المفضلة غير متاحة بعد.",
    cartUnavailable:
      "السلة غير متاحة. يرجى استخدام اشتر الآن لطلب عنصر واحد.",
  },
};
